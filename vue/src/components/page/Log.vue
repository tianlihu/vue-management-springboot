  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="query.logId" placeholder="日志ID" class="handle-input mr10" style="width:120px;" />
        <el-input v-model="query.userId" placeholder="用户ID" class="handle-input mr10" style="width:120px;" />
        <el-input v-model="query.type" placeholder="类型" class="handle-input mr10" style="width:120px;" />
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="logId" label="日志ID" width="55" align="center" />
...
<script>
import { fetchLog, saveLog, updateLog, deleteLog } from '../../api/log';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    deleteLog({ id: row.logId }).then(res => {
                        this.getData();
