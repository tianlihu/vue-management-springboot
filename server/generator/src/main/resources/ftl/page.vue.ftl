  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="query.${field.propertyName}" placeholder="${field.comment}" class="handle-input mr5" />
        </#list>
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange" v-loading="isShowloading">
        ...
        <#list table.fields as field>
        <el-table-column prop="${field.propertyName}" label="${field.comment}" sortable width="150" />
        </#list>
